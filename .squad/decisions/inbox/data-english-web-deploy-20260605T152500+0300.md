...
- **Decision:** Use Expo web export deployed from the public repository `tamirdresher/jellybolt-word-sparks` on branch `gh-pages` as the no-install Android fallback.
...
- **Verification:** `https://tamirdresher.github.io/jellybolt-word-sparks/` returned HTTP 200 and the referenced JS bundle returned HTTP 200 with JavaScript content.
- **Decided by:** Tamir Dresher; executed by Sonic (data).
